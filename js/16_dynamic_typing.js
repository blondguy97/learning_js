...
console.log('https://vk.com/catalog/' + num); // строка http://vk.com/catalog/4. Это старый способ объединения строк и переменных. Без применения интеполяции с помощью бэктиков
...
console.log(typeof +'4'); // number. Унарный плюс. Мы переделали строку 4 в цифру 4 с помощью унарного плюса

...
// Объекты нужны для хранения любых типов данных, в них могут содержаться все те типы о которых было сказано выше. А также в объектах могут быть функции (в объектах он иназываются методы) и массивы

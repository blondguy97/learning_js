...
1) База Рекурсии - это число которое сразу приводит к завершению функции    
...
/* Например у нас есть задача посчитать весь прогресс во всех массивах и объектах в этом большой объекте students, то есть объединить все цифры из свойств progress. Для этого можно воспользовать либо циклом либо рекурсией   


Чтобы понять средний прогресс всех студентов в объекте. Нужно Первое - понять сколько вообще студентов имеется, Второе - общее число в процентах, потом мы берем это число и делим на кол-во студентов*/

...
let btns = document.getElementsByTagName('button'); /* Сейчас сюда мы получили не один какой-то элемент button, а псевдомассив со всеми кнопками на странице. То есть HTML-коллекцию Чтобы получить конкретную кнопку на странице, мы должны указать индекс элемента
*/
...
У querySelectorAll есть одна суперспособность, это метод forEach, с помощью которого мы можем проходится по каждому элементу ПСЕВДОмассива и делать с ним что-то
*/

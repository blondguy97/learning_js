...
let something = (a, b) => {return a + b}; // Стрелочная функция
let something_2 = (a, b) => {console.log (`i love ${a} and ${b}`)}; // Стрелочная функция

let something_3 = (a, b) => {
    alert(a - b);
}; // Стрелочная функция

something_2('icecream', 'burgers'); 

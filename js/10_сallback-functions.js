...
Все то же самое что и было. Только тут один момент, как передавать существующую функцию в аргументы, заметь что я ее не вызывал (не было круглых скобок), ведь она и так вызывается внутри функции. То есть как бы сказали "выполни функцию done когда ты до нее доберешься в коде, плиз"

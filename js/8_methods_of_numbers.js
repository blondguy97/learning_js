...
logg_2.trim(); // 'i love spaces'. Метод trim() удаляет пробельные символы с начала и конца строки. Удобно для того чтобы пользователь например в ответах не мог вводить одни пробелы и это засчитывалось бы.
...
console.log(parseInt(test)); // Переводит в другую систему исчисления. Переводим в числовой тип данных и округляем до целого. В нашем случае до 12ти, без дробных значений

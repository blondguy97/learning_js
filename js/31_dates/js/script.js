...
Почему я задал 10ый месяц, то есть октябрь, а посчиталось что ноябрь? Потому что здесь месяцы считаются с нуля до 11, а не до 12ти. И то есть нулевой месяц это январь*/
    ...
    /* Кроме прямой передачи строки в параметры date, можно также передать кол-во миллисекунд которые также будут превращены в дату. Любая дата которая есть в js - хранится в миллисекундах, это timeStamp, кол-во миллисекунд отсчитывается сначала 1970 года */

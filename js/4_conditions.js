...
console.log(burgers === 5 && frenchfries); // 0. Так как логическая И всегда возвращает первое ложное выражение. 
// Есть поговорка для этих условий. && (И) всегда спотыкается на лжи, || (или) всегда спотывается на правде.

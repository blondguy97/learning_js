...
// то есть в цикле задается вопрос, 50 меньше или равно 55ти? Да, то есть true, выводим в консоль 50. С помощью инкремента, увеличиваем на единицу, опять вопрос 51 меньше чем 55? Да, опять вывод в консоль увеличение на единицу. И так далее до 54, ведь вопрос 55 меньше 55ти будет false и цикл закончится.

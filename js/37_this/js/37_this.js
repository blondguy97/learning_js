...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showThis(a, b) {
        ...
        function sum() {
            ...
            return a + b; /* Происходит замыкание функции, и функция sum не найдя внутри себя параметры a и b находит их в родительской функции showThis и считает сумму этиъ параметров */
        }
    ...
    const obj = {
        ...
        b: 15,
        sum: function () {
            console.log(this); // В консоль получаем объект в котором находится этот метод sum
            console.log(this.b); // 15. Метод sum указал конкретное свойство b своего объекта obj
        }
    }
